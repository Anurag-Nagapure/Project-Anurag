...
<body>
	...
	<div class="banner">
		<div class="homepageContainer">
			...
			<p class="bannerTagline">
				"Track your goods throughout entire supply chain from purchasing to production to end sales."
			</p>
	...
	<div class="homepageContainer">
		<div class="homepageFeatures">
			<div class="homepageFeature">
				...
				<p class="featureDescription">Lorem ipsum dolor sit amet,consectetur adopsing elit. Suspendisse fringilla fringilla.</p>
			</div>
			<div class="homepageFeature">
		...
		<div class="homepageNotified">
			<div class="homepageContainer">
				<div class="homepageNotifiedContainer">
					...
					<p>Lorem ipsum dolor sit amet,consectetur adopsing elit. Suspendisse fringilla fringilla Lorem ipsum dolor sit amet,consectetur adopsing elit. Suspendisse fringilla fringilla Lorem ipsum dolor sit amet,consectetur adopsing elit. Suspendisse fringilla fringilla.</p>	
					<form action="">
	...
	<div class="socials">
		<div class="homepageContainer">
			...
			<p class="socialText">Lorem ipsum dolor sit amet,consectetur adopsing elit Suspendisse.</p>
